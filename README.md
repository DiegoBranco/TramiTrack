...
Nota: Es necesario tener instalado pnpm en el equipo, la instalación puede variar segun el SO.
...
Dentro de server/seeds/index.js hay unos datos inciales para poder probar la aplicación.
